...
uint32_t Save_save_data_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("aid", ::apache::thrift::protocol::T_I32, 3);
  xfer += oprot->writeI32(this->aid);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("bid", ::apache::thrift::protocol::T_I32, 4);
...
int32_t SaveClient::save_data(const std::string& username, const std::string& password, const int32_t aid, const int32_t bid)
{
  send_save_data(username, password, aid, bid);
  return recv_save_data();
}

void SaveClient::send_save_data(const std::string& username, const std::string& password, const int32_t aid, const int32_t bid)
{
  int32_t cseqid = 0;
...
void SaveProcessor::process_save_data(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->save_data(args.username, args.password, args.aid, args.bid);
...
int32_t SaveConcurrentClient::save_data(const std::string& username, const std::string& password, const int32_t aid, const int32_t bid)
{
  int32_t seqid = send_save_data(username, password, aid, bid);
  return recv_save_data(seqid);
}

int32_t SaveConcurrentClient::send_save_data(const std::string& username, const std::string& password, const int32_t aid, const int32_t bid)
{
